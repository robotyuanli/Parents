    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12" style="padding-top:50px;">
                <h2 style="text-align: center; font-size:30px;font-weight: bold;">Edit Admin</h2>
            </div>
                        {!! Form::open(array('route' => ['users.update', $user->id], 'method' => 'PUT', 'role' => 'form', 'class' => 'needs-validation', 'style'=>'width:100%')) !!}
            ...
            <div class="col-md-8" style="padding-top:50px;">
                            ...
                            <div class="pw-change-container" style="display: block;">
