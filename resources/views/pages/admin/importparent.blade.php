    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12" style="padding-top:50px;">
                <h2 style="text-align: center; font-size:30px;font-weight: bold;">Import Parents</h2>
            </div>
            <div class="col-md-12">
        ...
        $('#import-csv-form').on("submit", function(e){
            ...
            $.ajax({
                ...
                success: function(result){
                    ...
                    if(code == 200)
                    {
                        $('#content').html('All records inserted Successfully.');
                        $('#content2').html('');

                    }else if(code == 401){
                        $('#content').html('File is empty.');
                        $('#content2').html('');
                    }else if(code == 404){
                        $('#content').html('Did not select csv file.');
                        $('#content2').html('');
                    }else if(code == 406){
                        $('#content').html('Something wrong! Please check column name.');
                        $('#content2').html('');
                    }else if(code == 500){
                        var message = result.err_msg;
                        $('#content2').html('');
                        $('#content').html(message);
                    }else if(code == 111){
                        var f = "Fail:" + result.csv + "\n";
                        var s = "Success:" + result.successCsv + "\n";
                        $('#content2').html(s);
                        $('#content').html(f );
                    }
