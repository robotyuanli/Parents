    ...
    <style>
   	...
   	<div class="container">
		 <div class="row top-bar" style="background: #00137f; color: white; text-align: center;">
				...
				<div class="col-md-6">
						<h3>Teacher: <?php if($teacher->prefix==1) echo "Mr";if($teacher->prefix==2) echo "Mrs";if($teacher->prefix==3) echo "Miss";if($teacher->prefix==4) echo "Ms";?> {{$teacher->first_name}} {{$teacher->last_name}}</h3>
				</div>
			</div>
			<div class="row">
